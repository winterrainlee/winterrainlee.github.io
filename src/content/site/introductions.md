...
guestbook:
  description: 겨울비 블로그 방명록
  intro: |-
    개별 글에 댓글 기능은 아직 제공하지 않습니다. 하고 싶은 말이 있으면 여기에 편하게 적어 주세요. 방명록을 적으시면 제 디스코드로 알람이 옵니다.  
    비밀글과 비밀글의 답변은 비밀글 작성 시 사용했던 비밀번호를 사용해야 볼 수 있으니 기억해 주세요.
---
