...
- Web3Forms access key, dashboard 설정, 수동 테스트 명령을 그대로 설명하는 runbook
- 관리자 페이지 경로와 사용 절차
- secret 이름과 헤더 이름을 포함한 운영 절차
- Discord webhook, Supabase secret, service role key, Web3Forms access key, 관리자 비밀번호와 관련된 설정 절차
