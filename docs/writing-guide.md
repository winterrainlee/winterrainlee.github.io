...
조금 더 눈에 띄게 남기고 싶은 인용, 주의, 정보는 Obsidian식 콜아웃을 쓴다.
...
> [!tip] 팁
> 글을 읽는 사람이 따라 하면 좋은 요령.

> [!warning] 주의
> 실수하기 쉬운 지점.

> [!danger] 위험
> 공개하면 안 되거나 크게 조심해야 하는 내용.

> [!quote] 예레미야 48:29
> 인용문을 강조해서 보여줄 때.
```

`[!quote]`는 따옴표 장식으로 표시된다. 다른 콜아웃은 색과 작은 표시로 구분된다.
...
너무 많은 콜아웃을 쓰면 글이 산만해진다. 평소에는 일반 인용문을 쓰고, 꼭 구분하고 싶은 부분에만 콜아웃을 쓴다.
